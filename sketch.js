...
function setup(){
  ...
  ground2 = createSprite(80,175,100,10);
  ground2.visible = false;
  
  cloudG = new Group();
  obG  = new Group(); 
  
  gameOver = createSprite(300,90,5,5);
  gameOver.addImage(gameOverI);
  gameOver.scale = 0.7;
  gameOver.visible = false;
  
  restart = createSprite(300,90,5,5);
